...
<body class="antialiased">
    <div
        ...
        <div class="banner">
            <div class="container">
                ...
                <h6 class="font-weight-normal text-muted pb-3 mt-4">Hanya dari rumah anda bisa mendaftar PPDB kedepannya
                </h6>
                <div>
                ...
                <img src="https://smktibazma.sch.id/static/media/masjid.d157934d98cee11f144c.jpg" alt=""
                    class="img-fluid">
            </div>
        </div>
    ...
    <script src="{{ asset('template/dist/css/owl.carousel.min.css') }}"></script>
    <script src="{{ asset('template/vendors/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('template/dist/css/materialdesignicons.min.css') }}"></script>
    <script src="{{ asset('template/dist/css/aos.css') }}"></script>
    <script src="{{ asset('template/dist/css/style.min.css') }}"></script>
</body>
