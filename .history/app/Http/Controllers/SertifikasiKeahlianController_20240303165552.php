...
class SertifikasiKeahlianController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Upload sertifikat
        $sertifikatFile = $request->file('sertifikat')->store('sertifikat');
        ...
        $data = [
            ...
            'sertifikat_file' => $sertifikatFile,
        ];
    ...
    public function update(Request $request, $id)
    {
        ...
        // Jika ada file sertifikat baru, upload dan update file
        if ($request->hasFile('sertifikat')) {
            $sertifikatFile = $request->file('sertifikat')->store('sertifikat');
            $updateData['sertifikat_file'] = $sertifikatFile;
        }
    ...
    public function destroy($id)
    {
        ...
        if ($sertifikasiKeahlian->sertifikat_file) {
            Storage::delete($sertifikasiKeahlian->sertifikat_file);
        }
