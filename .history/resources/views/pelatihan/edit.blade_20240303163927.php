                        ...
                        <div class="row px-4">
                            <div class="col-md-6 my-3">
                                <div class="form-group mb-3">
                                    <label for="namapelatihan" class="form-label">Tingkat pelatihan</label>
                                    <input type="text" name="posisi" class="form-control" id="namapelatihan"
                                        value="{{ $pelatihan->posisi }}">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Perusahaan</label>
                                    <input type="text" name="perusahaan" class="form-control"
                                        value="{{ $pelatihan->perusahaan }}">
                                </div>
                                <div class="form-group mb-3">
