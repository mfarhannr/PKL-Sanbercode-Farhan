        ...
        <div class="page-body">
            <div class="container">
                <div class="card">
                    ...
                    <form action="/pendidikan-karyawan" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row px-4">
                            <div class="col-md-6 mb-3">
                                <div class="form-group my-3">
                                    <label for="namapendidikan" class="form-label">Pilih Karyawan</label>
                                ...
                                <div class="form-group mb-3">
                                    <label for="namapendidikan" class="form-label">Nama</label>
