...
<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <h2 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">SMK
        </h2>
        </h1>
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                @if (Auth::check())
                                    ...
                                    <div class="dropdown-menu-column">
                                        <div class="dropend">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="{{ route('sertifikasi-keahlian.index') }}"
                                                    class="dropdown-item">
                    ...
                    @if (Auth::user()->role == 'karyawan')
                        {{-- <li class="nav-item">
                            <a class="nav-link" href="{{ route('karyawan.show', $karyawan->id) }}">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-user-circle" width="24"
                                        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('keluarga-karyawan.index') }}">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-user-circle" width="24"
                                        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    ...
                                    <div class="dropdown-menu-column">
                                        <div class="dropend">
                                            <a class="dropdown-item"
                                                href="{{ route('sertifikasi-keahlian.index') }}">
                                                Sertifikat
                                            </a>
                                        </div>
                                    </div>
