            ...
            <div class="container">
                <div class="card">
                  ...
                  <div class="card-body p-0">
                    <div class="row">
                    <div class="form-floating my-3 ms-2 col-6">
                        <input type="text" class="form-control" id="floatingInput" placeholder="masukkan username"
                            name="nama">
                        <label for="floatingInput">Username</label>
                    </div>
                    <div class="form-floating my-3 ms-2 col-5">
                        <input type="role" class="form-control rounded" id="floatingInput" placeholder="pilih role"
                            name="role">
