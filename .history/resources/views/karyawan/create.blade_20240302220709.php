                ...
                <div class="card">
                    ...
                    <form action="/karyawan" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="school_origin" class="form-control" placeholder="asal sekolah...">
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="parents_name" class="form-control" placeholder="masih ada/almarhum">
                        </div>
