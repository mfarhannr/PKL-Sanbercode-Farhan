...
@section('content')
    ...
    <label class="form-label border-dashed cursor-pointer" id="label" style="border-radius:10px;" for="imageFile">
        Masukkan Foto
        @if($karyawan->foto)
            <img class="img-preview img-fluid mb-2 mx-auto" src="{{ asset('storage/' . $karyawan->foto) }}" alt="Foto Karyawan">
        @else
            <img class="img-preview img-fluid mb-2 mx-auto" src="{{ asset('img/default-image.png') }}" alt="Default Image">
        @endif
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                 ...
                                 <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="tanggal_masuk" class="form-control" placeholder="..." value="{{ $karyawan->tanggal_masuk }}">
                                </div>
                            </div>
                            <div class="card-footer bg-transparent mt-auto">
                                <div class="btn-list justify-content-end">
                                    <button type="submit" class="btn btn-primary" href="/karyawan" >
                                        Back
                                    </button>
                                </div>
                            </div>
