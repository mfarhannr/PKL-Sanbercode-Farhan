                ...
                <div class="card">
                    ...
                    <form action="/karyawan" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="school_origin" l_origin" class="form-control"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-radio-input" type="radio" name="gender" r" value="0"
                                checked="">
                            <span class="form-radio-sign">Laki - Laki</span>
                            </label>
                            <label class="form-radio-label ml-3 mb-3">
                                <input class="form-radio-input" type="radio" name="gender" r"
                                    value="1">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="birthday" day" class="form-control"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="address" ss" class="form-control"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="disease" se" class="form-control"
                                placeholder="jika tidak ada riwayat penyakit maka isi - ">
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label">Nama Orangtua</label>
                            <input type="text" name="parents_name" ts_name" class="form-control"
