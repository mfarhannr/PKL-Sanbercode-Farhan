                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        value="{{ old('name', auth()->user()->name) }}"  Full Name">
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label h3">Email</label>
                                    <input type="text" name="email" class="form-control"
                                        value="{{ old('email', auth()->user()->email) }}"  email">
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" name="tanggal_lahir" class="form-control"
                                        value="{{ $karyawan->tanggal_lahir }}" gal lahir...">
                                </div>
                                <div class="mb-3">
                                    <label for="kota" class="form-label h3">Tempat lahir</label>
                                    <input type="text" name="tempat_lahir" class="form-control"
                                        value="{{ $karyawan->tempat_lahir }}" at Lahir">
                                </div>
                                <div class="mb-3">
