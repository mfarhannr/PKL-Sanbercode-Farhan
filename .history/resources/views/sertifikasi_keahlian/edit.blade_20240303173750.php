        ...
        <div class="page-body">
            <div class="container">
                <div class="card">
                    ...
                    <form action="/sertifikasi /{{ $sertifikasiKeahlian->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row px-4">
                            <div class="col-md-6 my-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nama_sertifikasi" class="form-control" id="namasertifikasi ">
                                </div>
                                <div class="form-group mb-3">
