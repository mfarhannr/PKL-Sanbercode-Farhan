            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-auto ms-auto">
                        <a href="{{ route('sert.create') }}" class="btn btn-primary">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($sert as $item)
                                        <tr>
                                            ...
                                            <td data-label="Name">
                                                <div class="d-flex py-1 align-items-center">
                                                    <div class="font-weight-medium">{{ $item->posisi }}</div>
                                                </div>
                                            </td>
                                            <td data-label="Name">
                                                <div class="d-flex py-1 align-items-center">
                                                    <div class="font-weight-medium">{{ $item->perusahaan }}</div>
                                                </div>
                                            </td>
                                            <td data-label="Name">
                                                <div class="d-flex py-1 align-items-center">
                                                    <div class="font-weight-medium">{{ $item->deskripsi }}</div>
                                                </div>
                                            </td>
                                            <td data-label="Name">
                                                <div class="d-flex py-1 align-items-center">
