                            ...
                            <div class="row px-4">
                                ...
                                <div class="form-floating my-3 ps-2 col-3">
                                    <input type="number" class="form-control" id="floatingInput"
                                        placeholder="masukkan username" name="tunjangan" value="{{ $gaji->tunjangan }}">
                                ...
                                <div class="form-floating my-3 ps-2 col-3">
                                    <input type="number" class="form-control" id="floatingInput" placeholder="Input"  value="{{ $gaji->gaji_pokok }}"
                                        name="gaji_pokok">
