                        ...
                        <div class="row px-4">
                            <div class="col-md-6 my-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="tingkat_pengalaman" class="form-control" id="namapengalaman" value="{{ $pengalaman->tingkat_pengalaman }}" > 
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Nama Sekolah</label>
                                    <input type="text" name="nama_sekolah" class="form-control" value="{{ $pengalaman->nama_sekolah }}">
                                </div>
                            </div>
