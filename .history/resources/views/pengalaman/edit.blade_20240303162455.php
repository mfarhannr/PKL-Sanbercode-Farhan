                        ...
                        <div class="row px-4">
                            ...
                            <div class="col-md-6 mb-5">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="tanggal_mulai" class="form-control" value="{{ $pengalaman->tanggal_mulai }}"
                                        >
                                </div>
                                 <div class="form-group mb-3">
                                    <label class="form-label">Tanggal sel</label>
                                    <input type="number" name="tanggal_sel" class="form-control" value="{{ $pengalaman->tanggal_sel }}"
                                        >
                                </div>
                                <div class="text-end">
