        ...
        <div class="page-body">
            <div class="container">
                <div class="card">
                    ...
                    <form action="{{ route('karyawan-keluarga.update', $karyawan->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row px-4">  
                            <div class="col-md-8 mb-3">
                                <div class="form-group my-3">
                                    ...
                                    <select name="id_karyawan" class="form-control mt-2">
                                        @foreach ($karyawan as $karyawanData)
                                            <option value="{{ $karyawanData->id }}"
                                                {{ $karyawanData->id == $keluarga->id_karyawan ? 'selected' : '' }}>
                                                {{ $karyawanData->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="alamat" class="form-control"
                                        value="{{ $karyawan->alamat }}" placeholder="asal sekolah...">
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <div class="card shadow-none border text-center">
                                        <label class="form-label border-dashed cursor-pointer" id="label"
                                            ...
                                            <input accept="image/*" type="file" name="foto"
                                                value="{{ $karyawan->foto }}"class="form-control mt-3" id="imageFile"
