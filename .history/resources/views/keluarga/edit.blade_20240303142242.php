        ...
        <div class="page-body">
            <div class="container">
                <div class="card">
                    ...
                    <form action="{{ route('keluarga-karyawan.update', $keluarga->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row px-4">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="namakeluarga" {{ $keluarga->jenis_kelamin }}>
                                    @error('nama')
